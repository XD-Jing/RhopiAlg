...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
else
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_RhopiAlgsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_RhopiAlgsetup.make
else
#cmt_local_setup = $(bin)RhopiAlgsetup$(cmt_lock_pid).make
...
$(cmt_local_tagfile_RhopiAlg) :
	...
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_RhopiAlg)"
	@if test -f $(cmt_local_tagfile_RhopiAlg); then /bin/rm -f $(cmt_local_tagfile_RhopiAlg); fi ; \
	  ...
	  if test -f $(cmt_final_setup_RhopiAlg); then /bin/rm -f $(cmt_final_setup_RhopiAlg); fi; \
	  $(cmtexe) -tag=$(tags) $(RhopiAlg_extratags) show setup >>$(cmt_final_setup_RhopiAlg)
	$(echo) setup.make ok
...
RhopiAlg :: $(RhopiAlg_dependencies) $(cmt_local_RhopiAlg_makefile)
	$(echo) "(constituents.make) Starting RhopiAlg"
	@$(MAKE) -f $(cmt_local_RhopiAlg_makefile) cmt_lock_pid=$${cmt_lock_pid} RhopiAlg
...
RhopiAlgclean :: $(RhopiAlgclean_dependencies) ##$(cmt_local_RhopiAlg_makefile)
	...
	@-if test -f $(cmt_local_RhopiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_RhopiAlg_makefile) cmt_lock_pid=$${cmt_lock_pid} RhopiAlgclean; \
	fi
...
RhopiAlginstall :: $(RhopiAlg_dependencies) $(cmt_local_RhopiAlg_makefile)
	...
	@-$(MAKE) -f $(cmt_local_RhopiAlg_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install RhopiAlg done"

uninstall :: RhopiAlguninstall

RhopiAlguninstall :: $(cmt_local_RhopiAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall RhopiAlg"
	@-$(MAKE) -f $(cmt_local_RhopiAlg_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(RhopiAlg_tag)_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_RhopiAlg_install_runtimesetup.make
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_RhopiAlgsetup.make
cmt_local_install_runtime_makefile = /tmp/CMT_install_runtime$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(RhopiAlg_tag)_config.make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_RhopiAlg_configsetup.make
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_RhopiAlgsetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(RhopiAlg_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_RhopiAlg_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_RhopiAlgsetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(RhopiAlg_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_RhopiAlg_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_RhopiAlgsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(RhopiAlg_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_RhopiAlg_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_RhopiAlgsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(RhopiAlg_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_RhopiAlg_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_RhopiAlgsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(RhopiAlg_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_RhopiAlg_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_RhopiAlgsetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(RhopiAlg_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_RhopiAlg_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_RhopiAlgsetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(RhopiAlg_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_RhopiAlg_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_RhopiAlgsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(RhopiAlg_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_RhopiAlg_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_RhopiAlgsetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(RhopiAlg_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_RhopiAlg_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(RhopiAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_RhopiAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
